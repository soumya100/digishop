...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var webHoookMiddleware, payload;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                webHoookMiddleware = body_parser_1.default.json({
                    verify: function (req, _, buffer) {
                        req.rawBody = buffer;
                    }
                });
                app.post('/api/webhooks/stripe', webHoookMiddleware, webhooks_1.stripeWebhookHandler);
            ...
            case 1:
                ...
                app.use(endpoints_1.apiEndPoints.trpc, trpcExpress.createExpressMiddleware({
                    router: trpc_1.appRouter,
                    createContext: createContext,
                })); //middleware to forward the request along with the api endpoints
                app.use(function (req, res) { return (0, next_utils_1.nextHandler)(req, res); }); // middleware to handle requests and responses
