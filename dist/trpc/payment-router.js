...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure
        ...
        var user, productIds, payload, rawProducts, products, filteredProducts, order, line_items, stripeSession, err_1;
    ...
    pollOrderStatus: trpc_1.privateProcedure
        ...
        var orderId, payload, rawOrders, orders, order;
        var input = _b.input;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
